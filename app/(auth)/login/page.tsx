      ...
      <div className="w-full max-w-lg flex flex-col gap-8">
          ...
          <div>
            ...
            <div className="relative mt-2">
              <input
                ...
                required
              />
              {/* <Mail className="absolute top-3.5 left-3 w-5 h-5 text-slate-400 pointer-events-none" /> */}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative mt-2">
              <input
                ...
                required
              />
              {/* <Lock className="absolute top-3.5 left-3 w-5 h-5 text-slate-400 pointer-events-none" /> */}
              <button
                type="button"
        ...
        {success && (
          <div className="bg-green-50 border border-green-300 rounded-lg p-5 flex items-center gap-3">
            ...
            <span className="text-green-700 font-semibold text-base">Login berhasil! Selamat datang, Admin.</span>
          </div>
        )}
